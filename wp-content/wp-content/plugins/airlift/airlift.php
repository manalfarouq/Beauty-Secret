...
if ((array_key_exists('bvplugname', $_REQUEST)) && ($_REQUEST['bvplugname'] == "airlift")) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
	...
	$pubkey = isset($_REQUEST['pubkey']) ? ALAccount::sanitizeKey(wp_unslash($_REQUEST['pubkey'])) : '';
