	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, '0986e90a9dc4c60f5d6032b80f71d360', 'c30be486420eaea1b24a630e32e01400');
		ALAccount::updateApiPublicKey($this->settings, '0986e90a9dc4c60f5d6032b80f71d360');
			}
